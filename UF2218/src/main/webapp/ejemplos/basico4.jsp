...
<%@include file="../includes/navbar.jsp" %>
	...
	<a href="getpost?nombre=periquito" class="btn btn-outline-primary">Peticion GET getpost?nombre=Manolo</a>
	...
	<h2>Ejemplo JSP</h2>
	<a href="getpost" class="btn btn-outline-info">Detectar JSP</a>
